...
export default function TransitionResults() {
  ...
  return (
    <>
      <section className="pt-20 pb-8 px-6 md:px-12 lg:px-16" data-testid="section-transition-results-header">
      ...
      <section className="pt-8 pb-20 px-6 md:px-12 lg:px-16" data-testid="section-transition-results">
        <div className="max-w-[1280px] mx-auto">
